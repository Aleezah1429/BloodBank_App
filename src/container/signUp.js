...
function SignUp(props) {
  ...
  const save_data=()=>{
    let user={
        name, email , pass , phone, bloodGroup 
    }
  ...
  return (
    ...
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor:'white' }}>
      <View>
        <Text style={{ fontSize: 50, color: 'white', fontWeight: 'bold',backgroundColor: "red",borderColor:'#8B0000',borderWidth:5, width:360, textAlign:'center', margin:15 }}>SIGNUP</Text>
      </View>
